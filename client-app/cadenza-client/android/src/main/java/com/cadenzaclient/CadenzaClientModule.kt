...
@ReactModule(name = CadenzaClientModule.NAME)
class CadenzaClientModule(reactContext: ReactApplicationContext) :
  NativeCadenzaClientSpec(reactContext) {
  ...
  // react-native-cadenza-client.cpp
  ...
  companion object {
    const val NAME = "CadenzaClient"

    init {
      System.loadLibrary("react-native-cadenza-client")
    }
  }
}