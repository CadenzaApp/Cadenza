...
export function TagsProvider({ children }: { children: ReactNode }) {
    ...
    async function loadSongTags(): Promise<Record<string, Tag[]>> {
        ...
        try {
            ...
            // Applied-tag metadata is optional for music playback and browsing. Keep
            // any previously loaded tags visible, and leave the state retryable so a
            // later successful request restores tag information automatically.
            console.warn(
                "Unable to load applied tags; continuing without tag metadata:",
                error,
            );
            setSongTagsLoaded(false);
            return {};
